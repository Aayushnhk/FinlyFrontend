                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <button
                        ...
                        className={`w-full flex justify-center items-center gap-2 py-2 px-4 text-white ${
                            isSubmitting ? 'bg-teal-400 cursor-not-allowed' : 'bg-teal-600 hover:bg-teal-700 cursor-pointer'
                        } font-medium rounded-md transition-colors duration-200`}
                        disabled={isSubmitting}
                    >
                        <FaLock />
                        {isLogin ? "Sign in" : "Sign up"}
                        {/* You can add a spinner here conditionally if isSubmitting is true */}
